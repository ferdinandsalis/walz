...
import { Outlet, useMatch, useMatches } from '@remix-run/react'
import { LinkPhotoCard } from './_index.tsx'

import { handle as educationHandle } from './ueber-uns_.philosophie.bildung.tsx'
import { handle as personalityHandle } from './ueber-uns_.philosophie.persoenlichkeit.tsx'
import { handle as practiceHandle } from './ueber-uns_.philosophie.praxis.tsx'
